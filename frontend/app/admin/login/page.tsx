      ...
      <main className="relative z-10 min-h-screen flex flex-col items-center justify-center p-6">
        <div className="absolute top-12 left-1/2 -translate-x-1/2 md:left-16 md:translate-x-0 transition-opacity duration-1000">
          <div className="flex items-center gap-3 opacity-60 hover:opacity-100 transition-opacity cursor-default">
            <span className="material-symbols-outlined text-3xl font-light text-amber-300">admin_panel_settings</span>
            <span className="font-headline tracking-[0.3em] uppercase text-sm font-light">Admin Dashboard</span>
          </div>
        </div>
          ...
          <div className="glass-morphism rounded-[2.5rem] p-10 md:p-16 text-center shadow-2xl">
            <header className="mb-12">
              <h1 className="font-headline font-extralight text-4xl md:text-5xl tracking-tight mb-4 text-white">
                Admin <span className="text-amber-300 italic">Access</span>
              </h1>
              <p className="text-white/40 text-sm tracking-widest uppercase font-light">Administrative Dashboard Login</p>
            </header>
            ...
            <form className="space-y-10" onSubmit={handleSubmit}>
              ...
              <div className="text-left space-y-3">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/20 rounded-lg px-4 py-3 text-white placeholder-white/40 focus:outline-none focus:border-amber-300/50 focus:bg-white/10 transition-all"
                  required
                />
              </div>
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 rounded border-white/20 accent-amber-300"
                  />
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-light tracking-wide py-3 rounded-lg transition-all duration-300"
              >
