...
export default function Sidebar({ activePage = 'Dashboard' }: SidebarProps) {
  const navItems = [
    ...
    { icon: 'calendar_today', label: 'Appointments', href: '/admin/appointments' },
    { icon: 'monitoring', label: 'Treatments', href: '/admin/treatments' },
    { icon: 'receipt_long', label: 'Financials', href: '/admin/financials' },
  ];
